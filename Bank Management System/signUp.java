...
//       Below we are defining - TextFields,Buttons 
//       How it should look on frame
      
        JLabel formNo = new JLabel("APPLICATION FORM No: " + random);        
//     In this we create object of New Font 
...
//      Set Bounds is used to set it on the Frame
...
//         Random is of long value - "" it will make it a string value
...
//      Value which user will enter will be initialized in variable for entering into database
